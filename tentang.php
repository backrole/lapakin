...
<body>
    ...
    <div style="background-color: #f6f6f6">
        <div class="container">
            <h1>Tentang Lapak Malang</h1>
            <p>Lapak Malang (LPK Malang) merupakan situs belanja online terpercaya yang menjual berbagai macam produk kebutuhan anda sehari - hari. Hubungi kami untuk informasi lengkapya dan reservasi pemesanan</p></br>
            <h5>Head Office <i class="fa fa-home"></i></h5>
            <p>Perum. Griya sampurna sejahtera, C2/9, Ampeldento, Karangploso, Kab. Malang</p>
            <h5>Phone <i class="fa fa-phone"></i></h5>
            <p>0813 5858 4440</p>
            <h5>Email <i class="fa fa-envelope"></i></h5>
            <p>lapakmalang@gmail.com</p>
        </div>
    </div>
