...
<body>
    ...
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="swiper-container" style="height: 240px;">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" style="background-image:url(https://placeholdit.imgix.net/~text?txtsize=68&amp;txt=Slideshow+Image&amp;w=1920&amp;h=500);">
                                <div></div><img class="img-fluid ml-auto img-fluid" src="assets/img/agreement-business-clapping-990817.jpg" style="align: center;margin-top: auto;margin-bottom: auto;min-width: 50%;margin-right: auto;margin-left: auto;">
                                <div></div>
                            </div>
                        ...
                        <div class="swiper-button-next" style="height: 20px;filter: brightness(0%) contrast(0%) saturate(0%);"></div>
                    </div>
                </div>
                <div class="col-md-8">
                    <p class="text-center">Testimoni</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="simple-slider">
        <div class="swiper-container">
            ...
            <div class="swiper-button-next" style="height: 114px;"></div>
        </div>
    </div>
    <div></div>
